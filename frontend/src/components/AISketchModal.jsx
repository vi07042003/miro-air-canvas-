...
export default function AISketchModal({
  ...
  return createPortal(
    <div className="modal-backdrop-glass" onClick={generating ? null : onClose}>
      <div className="glass-panel-heavy modal-content-scroll" style={{ ...styles.modalContent, maxWidth: '600px' }} onClick={e => e.stopPropagation()}>
